...
public class SignUpController {
	...
	@PostMapping("/fpotpgenarated")
	public ResponseEntity<?> fpotpgenarated(@RequestBody Map<String, String> request) {
	...
	public ResponseEntity<?> forgetOtpCheck(@RequestParam("email") String email, @RequestParam("otp") int otp) {
