...
public class SignUpService {
	...
	public ResponseEntity<?> changeUserPassword(String email, String newPassword) {
	    ...
	    if (userSignUp.isPresent()) {
	    	...
	    	String newpasswordString=passwordEncoder.encode(newPassword);
	    	
	        int updatedRows = signUpRepo.UpdateByEmailAndPassword(newpasswordString, userSignUp.get().getUserId());
